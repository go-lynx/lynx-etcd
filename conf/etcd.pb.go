...
type Etcd struct {
	...
	EnableRegister bool `protobuf:"varint,21,opt,name=enable_register,json=enableRegister,proto3" json:"enable_register,omitempty"`
	// enable_discovery whether to enable service discovery.
	// When enabled, services can be discovered from etcd.
	EnableDiscovery bool `protobuf:"varint,22,opt,name=enable_discovery,json=enableDiscovery,proto3" json:"enable_discovery,omitempty"`
	...
	RegistryNamespace string `protobuf:"bytes,23,opt,name=registry_namespace,json=registryNamespace,proto3" json:"registry_namespace,omitempty"`
	...
	Ttl           *durationpb.Duration `protobuf:"bytes,24,opt,name=ttl,proto3" json:"ttl,omitempty"`
...
func (x *Etcd) GetEnableRegister() bool {
	if x != nil {
...
func (x *Etcd) GetEnableDiscovery() bool {
	if x != nil {
...
func (x *Etcd) GetRegistryNamespace() string {
	if x != nil {
...
const file_etcd_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"etcd.proto\x12\x19lynx.protobuf.plugin.etcd\x1a\x1egoogle/protobuf/duration.proto\"\xf9\a\n" +
	"\x04Etcd\x12\x1c\n" +
	...
	"\x0eservice_config\x18\x14 \x01(\v2(.lynx.protobuf.plugin.etcd.ServiceConfigR\rserviceConfig\x12'\n" +
	"\x0fenable_register\x18\x15 \x01(\bR\x0eenableRegister\x12)\n" +
	"\x10enable_discovery\x18\x16 \x01(\bR\x0fenableDiscovery\x12-\n" +
	"\x12registry_namespace\x18\x17 \x01(\tR\x11registryNamespace\x12+\n" +
	"\x03ttl\x18\x18 \x01(\v2\x19.google.protobuf.DurationR\x03ttl\"\x9b\x01\n" +
...
var file_etcd_proto_depIdxs = []int32{
	...
	2, // 5: lynx.protobuf.plugin.etcd.Etcd.ttl:type_name -> google.protobuf.Duration
